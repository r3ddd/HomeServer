...
CONFIG_DATASETS=("prowlarr" "radarr" "sonarr" "readarr" "jellyseerr" "recyclarr" "profilarr" "bazarr" "tdarr" "jellyfin" "qbittorrent" "dozzle" "lidarr" "profilarr")
...
services:
  ...
  readarr:
    ...
    networks:
      - media_network
    volumes:
      - /mnt/$POOLNAME/configs/readarr:/config
      - /mnt/$POOLNAME/media:/media
  ...
  profilarr:
    ...
    networks:
      - media_network
    volumes:
      - /mnt/$POOLNAME/configs/profilarr:/config
